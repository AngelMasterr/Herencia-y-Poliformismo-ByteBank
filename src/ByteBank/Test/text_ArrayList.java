...
public class text_ArrayList {
	...
	public static void main(String[] args) {
		...
		// ArrayList: crea un array que solo agrega los elementos en orden. no a eptya elementos vacios
		// <Cuenta> estoy forzando a que el array solo acepte el tipo de objeto "Cuenta", es recomendable indicar el tipo de objeto que manejara el array
